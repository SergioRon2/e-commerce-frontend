...
import CarouselOne from '../../../../public/carrousel-1.jpg'
import CarouselTwo from '../../../../public/carrousel-2.jpg'
import CarouselThree from '../../../../public/carrousel-3.jpg'
            ...
            <div id="default-carousel" className="relative" data-carousel="static">
                <div className="overflow-hidden relative h-56 rounded-lg sm:h-64 xl:h-80 2xl:h-96">
                    <div className="hidden duration-700 ease-in-out" data-carousel-item>
                        ...
                        <Image src={CarouselOne} className="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="Carousel one" />
                    </div>
                    <div className="hidden duration-700 ease-in-out" data-carousel-item>
                        <Image src={CarouselTwo} className="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="Carousel two" />
                    </div>
                    <div className="hidden duration-700 ease-in-out" data-carousel-item>
                        <Image src={CarouselThree} className="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="Carousel three" />
                    </div>
                </div>
