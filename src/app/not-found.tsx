...
export default function NotFound(){
    return (
        <main className="flex justify-center max-h-screen items-center min-h-screen bg-white">
            ...
            <div className="hidden lg:block w-1/2">
                <Image className="w-auto" draggable={'false'} alt="not-found" src={NotFoundImage} width={0} height={0} />
            </div>
        </main>
    )
}