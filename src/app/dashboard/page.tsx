...
export default function Dashboard(){
    ...
    const labels: string[] = ['Valores'];
    const cantidad: number[] = [45385];
    ...
    return <>
        <NavbarAdmin />
        <div className="flex w-full overflow-hidden bg-white mt-8">
                                ...
                                <tbody className="divide-y divide-gray-100">
                                        ...
                                        <td className="border-t-0 px-4 align-middle text-xs whitespace-nowrap p-4">
                                            ...
                                            <div className="relative w-full">
                                                <div className="w-full bg-gray-200 rounded-sm h-2">
                                                    <div className="bg-cyan-600 h-2 rounded-sm w-2/6"></div>
                                                </div>
                                            </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr className="text-gray-500">
                                        ...
                                        <td className="border-t-0 px-4 align-middle text-xs whitespace-nowrap p-4">
                                            ...
                                            <div className="relative w-full">
                                                <div className="w-full bg-gray-200 rounded-sm h-2">
                                                    <div className="bg-orange-300 h-2 rounded-sm w-3/12"></div>
                                                </div>
                                            </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr className="text-gray-500">
                                        ...
                                        <td className="border-t-0 px-4 align-middle text-xs whitespace-nowrap p-4">
                                            ...
                                            <div className="relative w-full">
                                                <div className="w-full bg-gray-200 rounded-sm h-2">
                                                    <div className="bg-teal-400 h-2 rounded-sm w-2/12"></div>
                                                </div>
                                            </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr className="text-gray-500">
                                        ...
                                        <td className="border-t-0 px-4 align-middle text-xs whitespace-nowrap p-4">
                                            ...
                                            <div className="relative w-full">
                                                <div className="w-full bg-gray-200 rounded-sm h-2">
                                                    <div className="bg-pink-600 h-2 rounded-sm w-2/12"></div>
                                                </div>
                                            </div>
                                            </div>
                                        </td>
